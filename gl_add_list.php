...
<?php
	...
	if(isset($_GET['va_id'])) {
		...
		$anzahl_gl = getAmountOf($va_id, 0);
		$anzahl_hp = getAmountOf($va_id, 1);
		$anzahl_fl = getAmountOf($va_id, 2);

		echo "<p>Besteliste für Veranstaltung: $va_name</p>";
		echo "<p>Aktueller Stand: </p>";
		echo "<p>Besteliste: $anzahl_gl</p>";
		echo "<p>Half-Price: $anzahl_hp</p>";
		echo "<p>Schneggolist: $anzahl_fl</p>";
?>
